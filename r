23.09 13:13:58.809  INFO [           trans-04] r.sber.poirot.dpa.client.HttpDpaClient  : Send notify req to dis-pro-adapter taskId=[618902, DONE, MONITORING_KSB], taskStatus={}, processType={}
23.09 13:13:59.437 ERROR [Dispatcher-worker-1] a.w.r.e.AbstractErrorWebExceptionHandler: [e85b96bc-961]  500 Server Error for HTTP POST "/api/agreement/agree/618902"
...
Error has been observed at the following site(s):
	...
	*__checkpoint ⇢ SecurityConfig$$Lambda$1304/0x0000000801ae11d8 [DefaultWebFilterChain]
	...
	*__checkpoint ⇢ HTTP POST "/api/agreement/agree/618902" [ExceptionHandlingWebHandler]
Original Stack Trace:
		...
		at java.base/java.util.concurrent.ForkJoinWorkerThread.run(ForkJoinWorkerThread.java:165) почему может возникать такая ошибка и где package ru.sber.poirot.focus.stages
